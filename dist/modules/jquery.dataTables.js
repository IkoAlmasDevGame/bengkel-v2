...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		 ...
		 * menu (sizes are 6, 10, 25, 50 and 100). Requires pagination (`paginate`).
		 *  @type boolean
		 *  @default true
		 *
		 *  @dtopt Features
		...
		"oLanguage": {
			 ...
			 * with a default select list of 6, 10, 25, 50 and 100, and can be replaced
